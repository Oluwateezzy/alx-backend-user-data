...
class BasicAuth(Auth):
    ...
    def extract_user_credentials(self, decod_base_header: str) -> (str, str):
        """ extract user credentials """
        if decod_base_header is None or type(decod_base_header) != str:
            return None, None
        if ':' not in decod_base_header:
            return None, None
        lis = decod_base_header.split(':')
